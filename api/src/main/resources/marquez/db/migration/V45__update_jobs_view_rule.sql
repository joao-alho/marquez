...
DROP INDEX IF EXISTS jobs_namespace_uuid_name_null_parent CASCADE;

DROP INDEX IF EXISTS jobs_namespace_uuid_name_parent;
DROP INDEX IF EXISTS unique_jobs_namespace_uuid_name_parent CASCADE;

ALTER TABLE jobs ADD COLUMN parent_job_uuid_string char(36) DEFAULT '';
UPDATE jobs
...
ALTER TABLE jobs
    ADD CONSTRAINT unique_jobs_namespace_uuid_name_parent UNIQUE (name, namespace_uuid, parent_job_uuid_string);
